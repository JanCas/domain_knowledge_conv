...
CALLBACKS = [
    ...
    EarlyStopping(monitor='mean_absolute_error', patience=20),
...
for cbfv in cbfv_list:
    for material_prop in material_prop_list:
        ...
        try:
            ...
            print('|   NUM DATAPOINTS -> TRAIN: {}, VAL: {}, TEST: {}'.format(data['train'].n, data['val'].n,
                                                                              data['test'].n))
            ...
            filename = f'{material_prop}_{strftime("%m_%d_%Y_%H_%M_%S", localtime())}.jpg'
